...
// // --- FIXED CardMotion (route-compatible) ---
const CardMotion = ({ children, className = "", delay = 0 }) => (
  <motion.div
    initial={{ opacity: 0, y: 40 }}
    animate={{ opacity: 1, y: 0 }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-min">
        ...
        >
          <div className="flex flex-col justify-center h-full">
            ...
            <motion.h1
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }} // 🔥 ensures it loads even on refresh
              whileInView={{ opacity: 1, y: 0 }} // keeps scroll animation behavior
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed max-w-2xl">
              I'm <span className="font-bold text-gray-900">Sandeep Rajput</span>,
              an MCA student and Full Stack Developer crafting fast, elegant, and high-quality digital experiences with cutting-edge web technologies.
            </p>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-bold text-gray-900">MCA Student</h3>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-indigo-500 pl-4">
              <h3 className="font-bold text-gray-900">MERN Stack Intern</h3>
              <p className="text-gray-600 text-sm">
  6-month MERN internship focused on full-stack development, APIs, and authentication.
</p>

              <p className="text-xs text-gray-500">2025 — 2025</p>
            </div>
        ...
        >
          ...
          <div className="text-gray-700">
            <p className="font-bold text-lg">Bachelor of Computer Applications</p>
            <p className="text-sm mt-1">• Full-time</p>
          ...
          {/* SPACE ADDED HERE */}
          <div className="h-4"></div>  {/* or use className="my-4" */}

          {/* MCA */}
          <div className="text-gray-700">
            <p className="font-bold text-lg">Master of Computer Applications</p>
            <p className="text-sm mt-1">2nd Year • Full-time</p>
            <p className="text-xs text-gray-600 mt-2">
              Focus: Web Development & Software Engineering
            </p>
          </div>
        ...
        >
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-center gap-2">
              <span className="w-2 h-2 bg-pink-500 rounded-full"></span>
              Music enthusiast – <span className="font-semibold">Rhythmo</span>
            </li>
          </ul>
        </CardMotion>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {["GEN AI", "Next.js 14", "TypeScript" ,"Advanced Animations"].map(
              (topic, i) => (
                <motion.div
